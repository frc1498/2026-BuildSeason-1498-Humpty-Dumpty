...
public class IntakeConfig {
    ...
    public IntakeConfig(){
     ...
     public void configureIntakeMotorRight(TalonFXConfiguration intakeRight){
        ...
        intakeRight.CurrentLimits.SupplyCurrentLimit = 60.0;    //Changed 3/26 to try to help current consumption. Was 60.
        intakeRight.CurrentLimits.SupplyCurrentLimitEnable = true;
        intakeRight.CurrentLimits.SupplyCurrentLowerLimit = 60.0;  //Changed 3/26 to try to help current consumption. Was 60.
    ...
    public void configureIntakeMotorLeft(TalonFXConfiguration intakeLeft){
        ...
        intakeLeft.CurrentLimits.SupplyCurrentLimit = 60;    //Updated 2-24-26 - is correct
        intakeLeft.CurrentLimits.SupplyCurrentLimitEnable = true;
        intakeLeft.CurrentLimits.SupplyCurrentLowerLimit = 60.0;
