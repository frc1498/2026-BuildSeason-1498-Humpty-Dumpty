...
public class IntakeConfig {
    ...
    public IntakeConfig(){
     ...
     public void configureIntakeMotorRight(TalonFXConfiguration intakeRight){
        ...
        intakeRight.CurrentLimits.SupplyCurrentLimit = 40;    //Updated 2-24-26 - is correct
        intakeRight.CurrentLimits.SupplyCurrentLimitEnable = true;
        intakeRight.CurrentLimits.SupplyCurrentLowerLimit = 40.0;
        intakeRight.CurrentLimits.SupplyCurrentLowerTime = 1;

        //Slot 0 Configs
        intakeRight.Slot0.kP = 0;  // An error of 1 rotation per second results in 2V output
        ...
        intakeRight.Slot0.kV = 0;  // KV for a Kraken X60 is 490 rpm/V. 490/60 is 8.1667 rps/V.  The inverse is 0.122449 V/rps.
    ...
    public void configureIntakeMotorLeft(TalonFXConfiguration intakeLeft){
        ...
        //Slot 0 Configs
        intakeLeft.Slot0.kP = 0;  // An error of 1 rotation per second results in 2V output
        ...
        intakeLeft.Slot0.kV = 0;  // KV for a Kraken X60 is 490 rpm/V. 490/60 is 8.1667 rps/V.  The inverse is 0.122449 V/rps.
