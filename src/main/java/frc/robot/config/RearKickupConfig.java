...
public class RearKickupConfig {
    //Constants go Here
    public static final int kRearKickupMotorCANID = 12;
    ...
    public void configureRearKickupMotor(TalonFXConfiguration rearKickup){
        ...
        rearKickup.MotorOutput.NeutralMode = NeutralModeValue.Brake;  //Set 2-17-26
        rearKickup.MotorOutput.PeakForwardDutyCycle = 1;
        rearKickup.MotorOutput.PeakReverseDutyCycle = -1;

        rearKickup.CurrentLimits.StatorCurrentLimit = 120.0;
        rearKickup.CurrentLimits.StatorCurrentLimitEnable = true;
        rearKickup.CurrentLimits.SupplyCurrentLimit = 20;    //Set 2-17-26
        rearKickup.CurrentLimits.SupplyCurrentLimitEnable = true;
        rearKickup.CurrentLimits.SupplyCurrentLowerLimit = 20.0;  //Was 80.  Turned down for current consumption issues.
        rearKickup.CurrentLimits.SupplyCurrentLowerTime = 1;

        //Slot 0 Configs
        rearKickup.Slot0.kP = 10;  // An error of 1 rotation per second results in 2V output
        ...
        rearKickup.Slot0.kV = 0.15;  // KV for a Kraken X60 is 490 rpm/V. 490/60 is 8.1667 rps/V.  The inverse is 0.122449 V/rps.
