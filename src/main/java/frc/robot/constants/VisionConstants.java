...
public class VisionConstants {
    ...
    public static class limelight {
        ...
        public static final double kSideOffset = -0.1111;     // 4-1/8 inches (-0.104775) from the center of the robot. New mount shifts it 0.25 in.
    ...
    public static class photonvision {
        ...
        public static final Transform3d kRobotToRightCamera = new Transform3d(new Translation3d(0.2794, -0.3302, 0.1810), new Rotation3d(0.2618, 0, -1.5708));
        ...
        public static final Transform3d kRobotToLeftCamera = new Transform3d(new Translation3d(0.2794, 0.3080, 0.1810), new Rotation3d(-0.2618, 0, 1.5708));
        // 11 in. (0.279400558801118 in meters) X
